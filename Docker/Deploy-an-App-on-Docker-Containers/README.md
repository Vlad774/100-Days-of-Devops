# 🛠️ Deploy-an-App-on-Docker-Containers
...
After running docker-compose up you can access the app with curl command curl :6400/
...
Connect to App Server 1 (Stratos Datacenter) using the credentials:

2. Navigate and Create Configuration
Go to the project directory and create the compose file:
