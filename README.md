...
| **[🐳 Docker](./Docker/)** | `Containerization`, `Compose` | ![Docker](https://img.shields.io/badge/-Docker-blue?logo=docker&logoColor=white) | 🟡 In Progress |
...
| **[☁️ Terraform](./Terraform/)** | `IaC`, `AWS` | ![Terraform](https://img.shields.io/badge/-Terraform-623ce4?logo=terraform&logoColor=white) | ⚪ Planned |
