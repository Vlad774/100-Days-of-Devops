...
| **[☁️ Terraform](./Terraform/)** | `IaC`, `AWS`, `Provisioning`, `State Management` | ![Terraform](https://img.shields.io/badge/-Terraform-623ce4?logo=terraform&logoColor=white) | ⚪ Planned |
| **[🔧 Git & Tools](./Git/)** | `Version Control`, `Branching`, `Rebase`, `Hooks` | ![Git](https://img.shields.io/badge/-Git-F05032?logo=git&logoColor=white) | ⚪ Planned |
